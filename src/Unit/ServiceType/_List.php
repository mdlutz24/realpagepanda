...
class _List extends AbstractSoapClientBase
{
     ...
     * - documentation: list unit information, including availability and pricing
     * @uses AbstractSoapClientBase::getSoapClient()
     * @uses AbstractSoapClientBase::setResult()
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \mdlutz24\realpagepanda\Unit\StructType\_List $parameters
     * @return \mdlutz24\realpagepanda\Unit\StructType\ListResponse|bool
     */
    public function _List(\mdlutz24\realpagepanda\Unit\StructType\_List $parameters)
    {
        try {
