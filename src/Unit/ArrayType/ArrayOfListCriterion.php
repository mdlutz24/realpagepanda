...
class ArrayOfListCriterion extends AbstractStructArrayBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \mdlutz24\realpagepanda\Unit\StructType\ListCriterion[]
     */
    public $ListCriterion;
    /**
     * Constructor method for ArrayOfListCriterion
     * @uses ArrayOfListCriterion::setListCriterion()
     * @param \mdlutz24\realpagepanda\Unit\StructType\ListCriterion[] $listCriterion
     */
     ...
     * @return \mdlutz24\realpagepanda\Unit\StructType\ListCriterion[]|null
     */
    ...
    public static function validateListCriterionForArrayConstraintsFromSetListCriterion(array $values = array())
    {
        ...
        foreach ($values as $arrayOfListCriterionListCriterionItem) {
            ...
            if (!$arrayOfListCriterionListCriterionItem instanceof \mdlutz24\realpagepanda\Unit\StructType\ListCriterion) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ListCriterion property can only contain items of type \mdlutz24\realpagepanda\Unit\StructType\ListCriterion, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @param \mdlutz24\realpagepanda\Unit\StructType\ListCriterion[] $listCriterion
     * @return \mdlutz24\realpagepanda\Unit\ArrayType\ArrayOfListCriterion
     */
     ...
     * @throws \InvalidArgumentException
     * @param \mdlutz24\realpagepanda\Unit\StructType\ListCriterion $item
     * @return \mdlutz24\realpagepanda\Unit\ArrayType\ArrayOfListCriterion
     */
    public function addToListCriterion(\mdlutz24\realpagepanda\Unit\StructType\ListCriterion $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \mdlutz24\realpagepanda\Unit\StructType\ListCriterion) {
            throw new \InvalidArgumentException(sprintf('The ListCriterion property can only contain items of type \mdlutz24\realpagepanda\Unit\StructType\ListCriterion, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
