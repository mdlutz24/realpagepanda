...
class RentMatrix_1 extends AbstractStructBase
{
     ...
     * @uses RentMatrix_1::setRow()
     * @uses RentMatrix_1::setLeaseTerm()
     * @uses RentMatrix_1::setLeaseTermMax()
     * @uses RentMatrix_1::setLeaseTermMin()
     * @uses RentMatrix_1::setNeededByDate()
     * @uses RentMatrix_1::setPropertyID()
     ...
     * @param \mdlutz24\realpagepanda\Unit\StructType\Row[] $row
     * @return \mdlutz24\realpagepanda\Unit\StructType\RentMatrix_1
     */
